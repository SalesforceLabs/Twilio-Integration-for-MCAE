...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>SendSmsAction</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SendSmsAction_Tests</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SendWhatsAppMessageAction</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SendWhatsAppMessageAction_Tests</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TwilioUtil</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TwilioUtil_Tests</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
        <editable>false</editable>
        <field>TwilioMCAESetting__mdt.FromPhoneNumberWhatsApp__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>TwilioMCAESetting__mdt.FromPhoneNumber__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>TwilioMCAESetting__mdt.MessagingServiceSid__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>TwilioMCAESetting__mdt-Twilio MCAE Setting Layout</layout>
    </layoutAssignments>
